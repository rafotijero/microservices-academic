package com.proyecto.audit.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, EnrollmentEventDTO> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, EnrollmentEventDTO.class.getName());

        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
                new JsonDeserializer<>(EnrollmentEventDTO.class, false));
    }
